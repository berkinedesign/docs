...
description: 'Enhance your Davinci AI platform with Google Analytics to track user behavior and gain valuable insights. This guide walks you through setting up Google Analytics for your Davinci AI website.'
---
...
<Info>Davinci AI supports GA for frontend and separate one for the Admin Dashboard, both have different setup mechanisms, below are configuration steps for both</Info>
...
<Steps>
  ...
  <Step title="Step 6">
     Login to the Davinci AI as Admin. Go to the **Admin Panel** -> **General Settings** -> **Global Settings** and scroll to **Google Analytics** section. <br />
